...
;
      ...
      (function (g) {
        ...
        g.append("svg:text")
           ...
           .style("dominant-baseline", "central")
        .call(function(text) {
  text.text("Yellow-bellied marmot");
})
;
      }(g.append("g")));
      (function (g) {
...
;
      ...
      (function (g) {
        ...
        g.append("svg:text")
           ...
           .style("dominant-baseline", "central")
        .call(function(text) {
  text.text("Lesser short-tailed shrew");
})
;
      }(g.append("g")));
      (function (g) {
